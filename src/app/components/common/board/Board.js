...
class Board extends Component {
  ...
  handleCellHovered = cell => {
    if (
      this.props.highlightOptions.length > 0 &&
      cell.isHighlight !== undefined
    ) {
  ...
  setHighlightCell = cellObj => {
    ...
    //clonedBoardStatus[cell.x][cell.y].isHighlight = true;
  ...
  render() {
    ...
    const isRunning =
      gameIsRunning !== undefined && gameIsRunning ? gameIsRunning : false;
